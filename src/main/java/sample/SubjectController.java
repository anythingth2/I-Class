...
public class SubjectController {
    ...
    private String path1 = "src/main/java/sample/login.fxml";

    @FXML private Pane sbj2;
    @FXML private Label name2;
    @FXML private Label label2;
    private String path2 = "src/main/java/sample/login.fxml";

    @FXML private Pane sbj3;
    @FXML private Label name3;
    @FXML private Label label3;
    private String path3 = "src/main/java/sample/login.fxml";
    ...
    @FXML private void onLeftAction() throws IOException {
        ...
        setSubject1Detail("OOAD", "Object Oriented Analysis and Design", "src/main/java/sample/login.fxml");
        setSubject2Detail("OOAD", "Object Oriented Analysis and Design", "src/main/java/sample/login.fxml");
        setSubject3Detail("OOAD", "Object Oriented Analysis and Design", "src/main/java/sample/login.fxml");
    }
    ...
    @FXML private void onRightAction() throws IOException {
        ...
        setSubject1Detail("SE", "Software Engineering", "src/main/java/sample/login.fxml");
        setSubject2Detail("ToC", "Theory of Computation", "src/main/java/sample/login.fxml");
        setSubject3Detail("CA", "Computer Architecture", "src/main/java/sample/login.fxml");
    }
